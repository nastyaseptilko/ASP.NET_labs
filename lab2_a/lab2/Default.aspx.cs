...
namespace lab2
{
    public partial class _Default : Page
    {
        ...
        {
            HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create(String.Format("http://f45212saa:50722/yyy.saa?ParmA={0}&ParmB={1}",
        ...
        protected void Post_Click(object sender, EventArgs e)
        {
            ...
            HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create("http://f45212saa:50722/yyy.saa");
        ...
        protected void ERROR_Click(object sender, EventArgs e)
        {
            try
            {
                HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create(String.Format("http://f45212saa:50722/err.gso"));
                rq.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)rq.GetResponse();
                StreamReader sr = new StreamReader(response.GetResponseStream());
                Response.Write(sr.ReadToEnd());
